    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('invoice', 'Invoice'), ('credit', 'Credit')], max_length=10)),
                ('region', models.CharField(choices=[('domestic', 'Domestic'), ('foreign', 'Foreign')], max_length=10)),
